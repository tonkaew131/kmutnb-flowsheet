<article class="prose mx-auto pt-12 pb-48">
	...
	<ul>
		<li>
			<p>
				This site uses <code class="code">Google Analytics</code> which is one of the most widespread
				and trusted analytics solution on the web for helping us to understand how you use the site and
				ways that we can improve your experience. These cookies may track things such as how long you
	...
	<p>
		...
		<a class="anchor" href="https://www.cookiepolicygenerator.com/sample-cookies-policy/">
	...
	<ul>
		<li>Email: nongtonkaew@gmail.com</li>
	</ul>
